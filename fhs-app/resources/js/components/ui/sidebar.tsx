        ...
        <SidebarContext.Provider value={contextValue}>
            <TooltipProvider delayDuration={0}>
                <div
                    ...
                    className={cn('group/sidebar-wrapper pb-6 sm:pb-0 flex min-h-svh w-full has-data-[variant=inset]:bg-sidebar', className)}
                    ref={ref}
                    {...props}
                >
                    {children}
    ...
    ({ className, onClick, ...props }, ref) => {
        ...
        return (
            <Button
                ...
                variant="ghost"
                size="icon"
                className={cn('h-9 w-9 [&_svg]:size-7 md:h-7 md:w-7 md:[&_svg]:size-4', className)}
                onClick={(event) => {
                    onClick?.(event);
                    toggleSidebar();
                }}
...
const SidebarMenuItem = React.forwardRef<HTMLLIElement, React.ComponentProps<'li'>>(({ className, ...props }, ref) => (
    <li ref={ref} data-sidebar="menu-item" className={cn('group/menu-item relative mt-2', className)} {...props} />
));
